...
ratings <- read.csv("/Users/brunodias/Documents/FPCC2/Lab3/dataset/ratings_summ.csv")
```
...
``` {r warning}
diferenca <- full_join(movies, ratings) 
...
``` {r}
movies1 <- read.csv("/Users/brunodias/Documents/FPCC2/Lab3/dataset/movies_expanded.csv")
ratings1 <- read.csv("/Users/brunodias/Documents/FPCC2/Lab3/dataset/ratings.csv")

media_diff <- full_join(movies1, ratings1) %>% na.omit
